...
class model:
    ...
    def __init__(self, path_to_database, path_to_target):
    ...
    def setup(self, scope, penalty_constant, duplicates=1):
        ...
        self.setobjective(self.Z,self.x,self.y, scope)
    ...
    def setobjective(self,Z,x,y,scope):
        print("Constructing objective function in "+scope+" case...")
        if(scope=="local_matrix"): # Coulomb case
            expr=gp.QuadExpr()
            T=self.target['rep']
