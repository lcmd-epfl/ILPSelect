...
config = {
    ...
    "target_names": [f"oseltamivir_{i:03d}" for i in range(1,number_of_scan_points)],
    "in_database": False,
    "plot_average_target_names": [f"oseltamivir_{i:03d}" for i in range(1,number_of_scan_points)],
    ###
